...
export default function AboutSection() {
  return (
    <section className="relative bg-[var(--sv-teal-pale)] pt-24 pb-16 md:pt-28 lg:py-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
        ...
        <div className="order-2 lg:order-1">
          <Reveal>
            <span className="font-bold uppercase tracking-[0.2em] text-[10px] sm:text-xs text-[var(--sv-green)]">
              Who We Are
            </span>
            
            <h2 className="text-3xl md:text-5xl font-extrabold text-[var(--sv-teal)] leading-tight mt-4 mb-6 tracking-tight">
              Sync<span className="">Vision</span> Research <br className="hidden md:block" /> Solution LLP
            </h2>

            <p className="text-lg md:text-xl font-medium text-[var(--sv-blue)] mb-6 border-l-4 border-[var(--sv-green)] pl-4">
              “Where Vision Meets Integrity”
            </p>

            <div className="space-y-6 text-[var(--sv-text-muted)] leading-relaxed text-sm md:text-base mb-10 font-light">
              <p>
                Headquartered in <span className="font-bold text-[var(--sv-teal)]">Pune</span>, with a strong operational presence in <span className="font-bold text-[var(--sv-teal)]">Thane</span> and <span className="font-bold text-[var(--sv-teal)]">Patna</span>, we are a quality-focused Site Management Organization (SMO).
              </p>
              <p>
            ...
            <div className="bg-white p-6 md:p-8 rounded-3xl shadow-xl shadow-[rgb(var(--sv-blue-rgb)_/_0.18)] border border-[var(--sv-blue-light)]/20">
              <h3 className="text-xl font-bold text-[var(--sv-teal)] mb-6">
                Why Partner With Us?
              </h3>
              ...
              <ul className="grid sm:grid-cols-1 gap-5">
                {[
                  ...
                  <li key={index} className="flex items-start gap-4 group">
                    <div className="mt-1 bg-[var(--sv-green)]/20 rounded-full p-1.5 transition-colors">
                      <CheckCircle2 className="w-4 h-4 text-[var(--sv-teal)]" />
                    </div>
                    <div>
                      <p className="text-[var(--sv-teal)] font-bold text-sm uppercase tracking-wide">{item.t}</p>
                      <p className="text-[var(--sv-text-muted)] text-sm mt-1">{item.d}</p>
                    </div>
                  </li>
                ))}
              </ul>
          ...
          <Reveal className="flex justify-center">
            <div className="relative w-full max-w-[550px]">
              ...
              <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl border-[12px] border-white aspect-[4/5] lg:aspect-square bg-slate-200">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[var(--sv-teal)]/45 to-transparent" />
              </div>

              {/* Floating Presence Badge */}
              <div className="absolute -bottom-6 right-6 bg-[var(--sv-teal)] text-white p-6 rounded-3xl shadow-2xl border border-white/10">
                <div className="flex items-center gap-3 mb-2">
                  <MapPin className="w-5 h-5 text-[var(--sv-green)]" />
                  <p className="font-bold text-sm tracking-widest uppercase">Our Reach</p>
                </div>
                <p className="text-[var(--sv-ice)] text-xs leading-relaxed">
                  Pune • Thane • Patna
                </p>
              </div>
...
export function MissionVisionSection() {
  return (
    <section className="py-24 bg-[var(--sv-teal)] text-[var(--sv-ice)] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 relative z-10">
        <Reveal>
          <div className="border-l-4 border-[var(--sv-green)] pl-8">
            <h3 className="text-[var(--sv-green)] font-bold uppercase tracking-[0.2em] text-sm mb-4">Our Vision</h3>
        ...
        <Reveal>
          <div className="border-l-4 border-[var(--sv-green)] pl-8">
            <h3 className="text-[var(--sv-green)] font-bold uppercase tracking-[0.2em] text-sm mb-4">Our Mission</h3>
            <p className="text-xl md:text-2xl font-light leading-relaxed">
