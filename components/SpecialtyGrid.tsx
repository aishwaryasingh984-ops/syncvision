...
export function SpecialtyGrid() {
  return (
    ...
    <section className="pt-20 pb-20 lg:pt-24 lg:pb-24 bg-[var(--sv-teal-20)] relative overflow-hidden">
      ...
      {/* Background Accent */}
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-[var(--sv-blue)]/5 rounded-full blur-3xl -z-10" />
        ...
        <Reveal className="mb-12 md:mb-16">
          <div className="border-l-4 border-[var(--sv-green)] pl-6">
            <h2 className="text-3xl md:text-4xl font-extrabold text-[var(--sv-teal)] tracking-tight">
              Clinical <span className="text-[var(--sv-blue)]">Focus</span>
            </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {areas.map((area, i) => (
            <Reveal key={i} delay={i * 50}>
              <div className="group p-8 lg:p-10 bg-white border border-slate-100 rounded-[2.5rem] hover:border-[var(--sv-green)]/30 shadow-sm hover:shadow-xl hover:shadow-[0_20px_40px_rgb(var(--sv-teal-rgb)_/_0.05)] transition-all duration-500 h-full flex flex-col">
                ...
                {/* Title */}
                <h3 className="text-xl font-bold text-[var(--sv-teal)] mb-3 tracking-tight">
                  {area.title}
                </h3>
                ...
                <div className="mt-auto pt-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                   <div className="h-[2px] w-8 bg-[var(--sv-green)]" />
                </div>
              </div>
            </Reveal>
          ))}
        ...
        <Reveal className="mt-16 text-center">
          <div className="inline-block px-6 py-3 bg-white border border-slate-100 rounded-full shadow-sm">
            <p className="text-[10px] uppercase tracking-[0.2em] font-bold text-slate-400">
              All therapeutic activities are governed by <span className="text-[var(--sv-teal)]">ICH-GCP</span> & <span className="text-[var(--sv-teal)]">Schedule Y</span> Compliance
            </p>
          </div>
        </Reveal>
      </div>
